...
class Solution:
    def mincostTickets(self, days, costs):
        ...
        # The maximum day in the year we need to consider
        last_day = days[-1]
        ...
        for day in range(1, last_day + 1):
            # If not a travel day, the cost remains the same as the previous day
            if day not in travel_days:
                dp[day] = dp[day - 1]
            else:
                # Calculate the minimum cost considering all pass options
                dp[day] = min(
